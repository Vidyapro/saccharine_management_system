...
<body>
	...
	<ul> <li> <h3 style="line-height:100px;color: white; margin-left:70px; font-family: comic sans ms;"> Enter your Customer id to get delivery details</h3> </li> </ul>

	<div> <input type="text" placeholder="Customer id" name="cid" required> </div>
